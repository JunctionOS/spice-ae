...
apt update
apt install -y nodejs libgl1 gfortran ruby php-cli python3-pil openjdk-21-jre-headless libopenblas-dev
EOT

sudo umount ${CHROOT}/proc

sudo cp ${JUNCTION_DIR}/install/sbin/ldconfig ${CHROOT}/sbin/
